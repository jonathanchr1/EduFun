...
<div class="container-fluid" style="margin-top: 25px; margin-bottom: 25px">
    <h1 style="margin-bottom: 25px">Data Science</h1>
    <div class="row">
        <div class="col-1">
            <img src="{{ asset('img/writer-img/writer2.png') }}" style="width: 90px; height: 90px">
        </div>
        ...
        @if ($co->type == "Data Science")
            <div class="row" style="margin-top: 25px; margin-bottom: 50px; margin-left: 50px">
                ...
                <div class="col-8">
                    ...
                    <a href="{{ route('show.cate.ds', $co->id) }}" style="border-radius: 50px; padding: 5px 20px 5px 20px; text-decoration: none; background-color: #071026; color: white">Read More</a>
                </div>
            </div>
        @endif
    @endforeach
